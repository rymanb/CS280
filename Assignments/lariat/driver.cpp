...
enum Action { InsertAt, Pushback, Pushfront, Compact, Erase, Popback, Popfront, Index, Find };
...
//            probabilities[ insertF / TotalF                                                                                       ]    =  Insert;
            ...
            probabilities.insert( std::make_pair(  insertF / TotalF                                                                                      , InsertAt ) );
            ...
            for ( int i=0; i<num_operations; ++i ) {
                ...
                if ( action == InsertAt ) { // insert is legal at indicies 0..current_size inclusively
